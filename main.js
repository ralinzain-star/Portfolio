    ...
    const i18n = {
      en: {
        ...
        'intro.bio2': 'If you want to see how I design AI products, start with <a href="wren-agent.html">One Product, Three Minds</a>, my rethink of conversational BI at Wren AI; <a href="thread-tracing.html">Closing the Loop</a>, on feedback systems that turn user signals into model instructions; or <a href="lsbg.html">Bicycle Lane Inspection</a>, an AI-assisted civic tool built for Hamburg\'s road maintenance team. For mobile systems work, there\'s the <a href="notification.html">Notification Framework</a> I led at Google Pixel, and <a href="a41.html">A41</a>, a native cross-store shopping experience I designed at Fable. For B2B SaaS, I built the <a href="rezio-ds.html">Rezio Design System</a> at KKday and redesigned the <a href="rezio.html">Rezio onboarding flow</a> that cut vendor setup time by 38%.',
        'intro.bio3': 'For how I think about AI and design more broadly, browse my <a href="#island-writing">Playground</a>, especially <a href="designing-with-ai.html">Designing with AI</a>, where I document the workflow that lets one designer carry 6–8 FTE of scope across parallel projects. I\'m currently building <a href="trip-planner.html">Trip Planner</a>, a Claude Code skill that turns travel research into interactive HTML guides.',
      ...
      'zh-tw': {
        ...
        'intro.bio2': '如果你想看看我怎麼設計 AI 產品，可以從 <a href="wren-agent.html">One Product, Three Minds</a> 開始，那是我在 Wren AI 重新思考對話式 BI 的案例；<a href="thread-tracing.html">Closing the Loop</a>，談的是如何設計把使用者訊號轉成模型指令的回饋系統；或是 <a href="lsbg.html">Bicycle Lane Inspection</a>，一款為漢堡道路養護團隊打造的 AI 公共服務工具。行動系統方面，有我在 Google Pixel 主導的 <a href="notification.html">Notification Framework</a>，以及我在 Fable 設計的原生跨店購物體驗 <a href="a41.html">A41</a>。B2B SaaS 方面，我在 KKday 打造了 <a href="rezio-ds.html">Rezio Design System</a>，並重新設計了 <a href="rezio.html">Rezio 廠商導入流程</a>，將設置時間縮短 38%。',
        'intro.bio3': '想了解我對 AI 與設計的看法，可以逛逛我的 <a href="#island-writing">Playground</a>，特別是 <a href="designing-with-ai.html">Designing with AI</a>，我在裡面記錄了一位設計師如何在平行專案裡承擔 6 至 8 FTE 的工作流。目前手邊的 side project 是 <a href="trip-planner.html">Trip Planner</a>，一款把旅行研究轉成互動 HTML 指南的 Claude Code Skill。',
      ...
      'zh-cn': {
        ...
        'intro.bio2': '如果你想看看我怎么设计 AI 产品，可以从 <a href="wren-agent.html">One Product, Three Minds</a> 开始，那是我在 Wren AI 重新思考对话式 BI 的案例；<a href="thread-tracing.html">Closing the Loop</a>，谈的是如何设计把用户信号转成模型指令的反馈系统；或是 <a href="lsbg.html">Bicycle Lane Inspection</a>，一款为汉堡道路养护团队打造的 AI 公共服务工具。移动系统方面，有我在 Google Pixel 主导的 <a href="notification.html">Notification Framework</a>，以及我在 Fable 设计的原生跨店购物体验 <a href="a41.html">A41</a>。B2B SaaS 方面，我在 KKday 打造了 <a href="rezio-ds.html">Rezio Design System</a>，并重新设计了 <a href="rezio.html">Rezio 厂商导入流程</a>，将配置时间缩短 38%。',
        'intro.bio3': '想了解我对 AI 与设计的看法，可以逛逛我的 <a href="#island-writing">Playground</a>，尤其是 <a href="designing-with-ai.html">Designing with AI</a>，我在里面记录了一位设计师如何在并行项目里承担 6 至 8 FTE 的工作流。目前手边的 side project 是 <a href="trip-planner.html">Trip Planner</a>，一款把旅行研究转成互动 HTML 指南的 Claude Code Skill。',
      ...
      ja: {
        ...
        'intro.bio2': 'AI プロダクトをどう設計しているかを見たい方は、Wren AI で会話型 BI を再設計した <a href="wren-agent.html">One Product, Three Minds</a>、ユーザーのシグナルをモデルへの指示に変えるフィードバックシステムを扱った <a href="thread-tracing.html">Closing the Loop</a>、そしてハンブルク市の道路整備チーム向けに設計した AI 支援ツール <a href="lsbg.html">Bicycle Lane Inspection</a> からどうぞ。モバイル系の仕事であれば、Google Pixel で率いた <a href="notification.html">Notification Framework</a>、Fable で設計したクロスストアのネイティブ購入体験 <a href="a41.html">A41</a> があります。B2B SaaS の領域では、KKday で <a href="rezio-ds.html">Rezio Design System</a> を構築し、セットアップ時間を 38% 短縮した <a href="rezio.html">Rezio の導入フロー</a> を再設計しました。',
