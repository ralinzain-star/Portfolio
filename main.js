    ...
    const i18n = {
      en: {
        ...
        'intro.bio2': 'If you want to see how I design AI products, start with <a href="wren-agent.html">One Product, Three Minds</a>, my rethink of conversational BI at Wren AI, or <a href="thread-tracing.html">Closing the Loop</a>, on feedback systems that turn user signals into model instructions. For mobile systems work, there\'s the <a href="notification.html">Notification Framework</a> I led at Google Pixel, <a href="a41.html">A41</a>, a native cross-store shopping experience I designed at None Capital, and the <a href="rezio-ds.html">Rezio Design System</a> I built at KKday.',
      ...
      'zh-tw': {
        ...
        'intro.bio2': '如果你想看看我怎麼設計 AI 產品，可以從 <a href="wren-agent.html">One Product, Three Minds</a> 開始，那是我在 Wren AI 重新思考對話式 BI 的案例，或者讀 <a href="thread-tracing.html">Closing the Loop</a>，談的是如何設計把使用者訊號轉成模型指令的回饋系統。行動系統方面，有我在 Google Pixel 主導的 <a href="notification.html">Notification Framework</a>、我在 None Capital 設計的原生跨店購物體驗 <a href="a41.html">A41</a>，以及在 KKday 打造的 <a href="rezio-ds.html">Rezio Design System</a>。',
      ...
      'zh-cn': {
        ...
        'intro.bio2': '如果你想看看我怎么设计 AI 产品，可以从 <a href="wren-agent.html">One Product, Three Minds</a> 开始，那是我在 Wren AI 重新思考对话式 BI 的案例，或者读 <a href="thread-tracing.html">Closing the Loop</a>，谈的是如何设计把用户信号转成模型指令的反馈系统。移动系统方面，有我在 Google Pixel 主导的 <a href="notification.html">Notification Framework</a>、我在 None Capital 设计的原生跨店购物体验 <a href="a41.html">A41</a>，以及在 KKday 打造的 <a href="rezio-ds.html">Rezio Design System</a>。',
      ...
      ja: {
        ...
        'intro.bio2': 'AI プロダクトをどう設計しているかを見たい方は、Wren AI で会話型 BI を再設計した <a href="wren-agent.html">One Product, Three Minds</a>、もしくはユーザーのシグナルをモデルへの指示に変えるフィードバックシステムを扱った <a href="thread-tracing.html">Closing the Loop</a> からどうぞ。モバイル系の仕事であれば、Google Pixel で率いた <a href="notification.html">Notification Framework</a>、None Capital で設計したクロスストアのネイティブ購入体験 <a href="a41.html">A41</a>、KKday で構築した <a href="rezio-ds.html">Rezio Design System</a> があります。',
