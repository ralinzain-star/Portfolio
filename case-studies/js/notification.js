  ...
  (function() {
    const notifI18n = {
      'en': {
        ...
        'nav.s05': '05.Impact',
        'page.title': 'System Notifications & Battery Experience Framework',
        'page.subtitle': 'Unifying scattered alerts and battery notifications into one reviewable system, built on Material 3 and the Android design system.',
        ...
        'intro.product.body3': 'The framework also extends to the battery experience, covering battery-related notifications and how battery usage is surfaced in the system UI, built on Material 3 and the Android design system.',
        'intro.label.role': 'My Role:',
        'intro.role.body': 'As the interaction designer, I <span class="stat-hi">audited and classified battery-related notifications and display</span>, co-developed the decision framework, and translated it into practical review tools. I aligned <span class="stat-hi">cross-functional teams</span> on shared standards, helped define the supporting classifier workflow, and documented the system so it could <span class="stat-hi">scale beyond a single feature team</span>. Throughout, I worked in Material 3 and the Android design system, following the platform\'s mobile design conventions.',
      ...
      'zh-tw': {
        ...
        'nav.s04': '04.AI 分類器',
        'nav.s05': '05.影響',
        'page.title': '系統通知與電池體驗框架',
        'page.subtitle': '將零散的警告與電池通知，整合為一致、可審查的系統框架，並建立在 Material 3 與 Android 設計系統之上。',
        ...
        'intro.product.body3': '框架也延伸到電池體驗，涵蓋電池相關的通知，以及電池用量在系統介面上的顯示方式，並建立在 Material 3 與 Android 設計系統之上。',
        'intro.label.role': '我的角色：',
        'intro.role.body': '身為互動設計師，我<span class="stat-hi">盤點並分類了電池相關的通知與顯示</span>、共同制定決策框架，並將其轉化為實用的審查工具。我凝聚<span class="stat-hi">跨職能團隊</span>的共識、協助定義分類器工作流，也撰寫系統文件，讓這套規範能<span class="stat-hi">擴展到單一功能團隊之外</span>。整個過程都依循 Material 3 與 Android 設計系統，以及平台的行動端設計規範。',
      ...
      'zh-cn': {
        ...
        'nav.s04': '04.AI 分类器',
        'nav.s05': '05.影响',
        'page.title': '系统通知与电池体验框架',
        'page.subtitle': '将零散的警告与电池通知，整合为一致、可审查的系统框架，并建立在 Material 3 与 Android 设计系统之上。',
        ...
        'intro.product.body3': '框架也延伸到电池体验，涵盖电池相关的通知，以及电池用量在系统界面上的显示方式，并建立在 Material 3 与 Android 设计系统之上。',
        'intro.label.role': '我的角色：',
        'intro.role.body': '作为交互设计师，我<span class="stat-hi">盘点并分类了电池相关的通知与显示</span>、共同制定决策框架，并将其转化为实用的审查工具。我凝聚<span class="stat-hi">跨职能团队</span>的共识、协助定义分类器工作流，也撰写系统文档，让这套规范能<span class="stat-hi">扩展到单一功能团队之外</span>。整个过程都遵循 Material 3 与 Android 设计系统，以及平台的移动端设计规范。',
      ...
      ja: {
        ...
        'nav.s04': '04.AI 分類器',
        'nav.s05': '05.インパクト',
        'page.title': 'システム通知とバッテリー体験フレームワーク',
        'page.subtitle': '散在するアラートとバッテリー通知を、統一されたレビュー可能な仕組みへ。Material 3 と Android デザインシステムに基づいて設計。',
        ...
        'intro.product.body3': 'フレームワークはバッテリー体験にも広がり、バッテリー関連の通知や、バッテリー使用状況をシステム UI でどう見せるかをカバーします。いずれも Material 3 と Android デザインシステムに基づいています。',
        'intro.label.role': '担当役割：',
        'intro.role.body': 'インタラクションデザイナーとして、<span class="stat-hi">バッテリー関連の通知と表示を監査・分類</span>し、意思決定フレームワークを共同で作り上げ、実用的なレビューツールへと落とし込みました。<span class="stat-hi">職能横断チーム</span>の認識を合わせ、分類器ワークフローの定義を支援し、単一の機能チームを超えて<span class="stat-hi">スケールできるようシステムをドキュメント化</span>しました。全体を通じて Material 3 と Android デザインシステムに沿い、プラットフォームのモバイルデザイン規約に従いました。',
