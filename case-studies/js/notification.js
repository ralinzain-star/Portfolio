  ...
  (function() {
    const notifI18n = {
      'zh-tw': {
        ...
        'intro.role.body': '身為互動設計師，我<span class="stat-hi">盤點並分類了與電池相關的通知</span>、共同制定決策框架，並將其轉化為實用的審查工具。我凝聚<span class="stat-hi">跨職能團隊</span>的共識、協助定義分類器工作流，也撰寫系統文件，讓這套規範能<span class="stat-hi">擴展到單一功能團隊之外</span>。',
      ...
      'zh-cn': {
        ...
        'intro.label.role': '我的角色：',
        'intro.role.body': '作为交互设计师，我<span class="stat-hi">盘点并分类了与电池相关的通知</span>、共同制定决策框架，并将其转化为实用的审查工具。我凝聚<span class="stat-hi">跨职能团队</span>的共识、协助定义分类器工作流，也撰写系统文档，让这套规范能<span class="stat-hi">扩展到单一功能团队之外</span>。',
      ...
      ja: {
        ...
        'intro.role.body': 'インタラクションデザイナーとして、<span class="stat-hi">バッテリー関連の通知を監査・分類</span>し、意思決定フレームワークを共同で作り上げ、実用的なレビューツールへと落とし込みました。<span class="stat-hi">職能横断チーム</span>の認識を合わせ、分類器ワークフローの定義を支援し、単一の機能チームを超えて<span class="stat-hi">スケールできるようシステムをドキュメント化</span>しました。',
