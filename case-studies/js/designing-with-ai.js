// ===== i18n =====
    const I18N = {
      ja: {
        ...
        's03.step5.story': 'prototypeを Figma に取り込み、レイアウトを整え、デザインシステムに沿うようコンポーネントを整える。次に Figma Make に入れ、表示ステートの探索と代替レイアウトの高速テストを行う。あるいは Claude Design でいくつかの UX 方向案をすばやく出し、それを Claude Code または Figma に戻して調整する。勝ち残ったものは Claude Code にプロンプトとして戻し、prototypeを更新する。ピクセルに直接触れるのはここだけ, そして一番短いステップです。',
      ...
      'zh-tw': {
        ...
        's03.step5.story': '我把prototype拉進 Figma 重新整理版面、讓元件對齊設計系統，再丟進 Figma Make 快速探索不同顯示狀態和替代版面。或是用 Claude Design 快速產出幾個 UX 方向，再回到 Claude Code 或 Figma 調整。哪個贏，我就帶著 prompt 回到 Claude Code 更新prototype。這是整個流程裡唯一我還在直接動像素的一步, 也是最短的一步。',
        's03.step5.tool': 'Figma＋Figma Make ⇄ Claude Code',
      ...
      'zh-cn': {
        ...
        's03.step5.title': '同步到 Figma → Figma Make → 回到prototype',
        's03.step5.story': '我把prototype拉进 Figma 重新整理版面、让组件对齐设计系统，再丢进 Figma Make 快速探索不同显示状态和替代版面。或是用 Claude Design 快速产出几个 UX 方向，再回到 Claude Code 或 Figma 调整。哪个赢，我就带着 prompt 回到 Claude Code 更新prototype。这是整个流程里唯一我还在直接动像素的一步, 也是最短的一步。',
        's03.step5.tool': 'Figma＋Figma Make ⇄ Claude Code',
