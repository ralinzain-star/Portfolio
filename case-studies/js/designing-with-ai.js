// ===== i18n =====
    const I18N = {
      ja: {
        ...
        's01.m2.note': 'ここに「デザイン待ち」の空白時間はありません。3〜4 つの戦線が同時進行:Agent Mode のロジック、Embedded Threads の体験、デザインシステムのメンテナンス。すべて稼働中で、列に並んで止まってはいません。',
        's01.m3.label': '構造に刻まれる時間',
        's01.m3.note': '週 16 時間、これは私が「人間」として支払わなければならないコミュニケーション税。40% の時間は会議でロックされ、削れません。つまり、残りの 1 分 1 分が数倍の価値を出さなければならないということです。',
        's01.m4.label': '24 時間、指揮者として',
        's01.m4.note': '会議を差し引いて、週に残る 24 時間こそが私の本当の戦場。1 プロジェクトあたり平均 6 時間にも満たない。狂気の沙汰?いいえ、図面を描く職人ではなく、Claude Code を指揮して構想を実装するシステムオーナーになったとき、1 週間分のワークロードは本当に 6 時間の中に収まります。',
        ...
        'intro.h3.role': '私の役割',
        'intro.role.body': 'Wren AI のシニアプロダクトデザイナー。そして必然的に、PM、リサーチャー、プロトタイパー、モーションデザイナー、イラストレーター、テクニカルライター、ドッグフーディングリード。このワークフローは、一人のデザイナーが従来<span class="stat-hi">〜6〜8 FTE</span>相当の職域を品質を保ちつつこなす方法です。',
        ...
        's02.li1': '<span class="stat-hi">一人のデザイナー</span>が、プロダクトデザイン、ビジュアルデザイン、プロトタイピング、リサーチ、ブランドを全プロダクトでカバー。',
        ...
        's02.reframe.body': '古い問い, <em>「どうやってデザインの時間を増やすか？」</em>, には答えがなかった。週は満杯だった。新しい問いはこうなった：<em>「自分の 1 時間を 5 倍に働かせるには？」</em> それは、私が成果物を作る人であることをやめ、成果物を作るシステムを指揮する人になった場合にのみ機能する。',
      ...
      'zh-tw': {
        ...
        's01.m2.note': '這裡沒有「等設計稿」的空窗期。3 到 4 條戰線同時推進:Agent Mode 的邏輯、Embedded Threads 的體驗、設計系統的維護，全部處於活動狀態，而非排隊掛機。',
        's01.m3.label': '被結構化切碎的時間',
        's01.m3.note': '每週 16 小時，是我身為「人類」必須付出的溝通稅。這 40% 的時間被會議鎖死，無法刪減。這也意味著，剩下的每一分鐘都必須發揮數倍的價值。',
        's01.m4.label': '24 小時的「指揮家」時刻',
        's01.m4.note': '扣掉會議，每週剩下的 24 小時是我真正的戰場。每個專案平均分不到 6 小時。聽起來很瘋狂？但當我不再是畫圖的工匠，而是指揮 Claude Code 實踐構思的系統負責人，一週的工作量，確實在 6 小時內落地。',
        ...
        'intro.h3.role': '我的角色',
        'intro.role.body': 'Wren AI 資深產品設計師。也因為現實需要:PM、研究員、prototype製作者、動效設計師、插畫師、技術文件寫手、dogfooding 負責人。這套工作流是一個人如何扛下<span class="stat-hi">約 6–8 個 FTE</span>的傳統職能範圍，又不讓作品品質掉下來的方法。',
        'intro.h3.time': '時間',
        ...
        's02.li1': '<span class="stat-hi">一人分飾多角</span>：從產品設計、品牌視覺到用戶研究，我就是整條設計生產線。',
        ...
        's02.h3.reframe': '視角轉換',
        's02.reframe.body': '舊問題,<em>「如何擠出更多時間設計？」</em>,已是死路；那一週早就滿了。新問題變成：<em>「如何讓自己的一小時發揮五小時的價值？」</em>',
      ...
      'zh-cn': {
        ...
        's01.m2.note': '这里没有「等设计稿」的空窗期。3 到 4 条战线同时推进:Agent Mode 的逻辑、Embedded Threads 的体验、设计系统的维护，全部处于活动状态，而非排队挂机。',
        's01.m3.label': '被结构化切碎的时间',
        's01.m3.note': '每周 16 小时，是我身为「人类」必须付出的沟通税。这 40% 的时间被会议锁死，无法删减。这也意味着，剩下的每一分钟都必须发挥数倍的价值。',
        's01.m4.label': '24 小时的「指挥家」时刻',
        's01.m4.note': '扣掉会议，每周剩下的 24 小时是我真正的战场。每个项目平均分不到 6 小时。听起来很疯狂？但当我不再是画图的工匠，而是指挥 Claude Code 实践构思的系统负责人，一周的工作量，确实在 6 小时内落地。',
        ...
        'intro.h3.role': '我的角色',
        'intro.role.body': 'Wren AI 资深产品设计师。也因为现实需要:PM、研究员、prototype制作者、动效设计师、插画师、技术文档撰写者、dogfooding 负责人。这套工作流是一个人如何扛下<span class="stat-hi">约 6–8 个 FTE</span>的传统职能范围，又不让作品品质掉下来的方法。',
        'intro.h3.time': '时间',
        'intro.time.body': '2026 → 至今',
        ...
        's02.li1': '<span class="stat-hi">一位设计师</span>扛起整个产品的产品设计、视觉、prototype、研究与品牌。',
        ...
        's02.li5': '创业公司预算排除了招人。',
        's02.h3.reframe': '视角转换',
        's02.reframe.body': '旧问题, <em>"我要怎么挤出更多时间来设计?"</em>, 没有答案。那周已经满了。新问题变成:<em>"我要怎么让自己的一小时发挥五小时的效果?"</em>这只在一种情况下成立：我不再是那个做产物的人，而是指挥一个会产出这些产物的系统的人。',
